...
namespace API.Data.Migrations
{
    ...
    [Migration("20260225121909_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "member-id",
                            ConcurrencyStamp = "f55269c7-9df5-48e8-bb28-97c5e00a906d",
                            Name = "Member",
                        ...
                        {
                            Id = "moderator-id",
                            ConcurrencyStamp = "86636373-3bb7-4ead-bb2a-577ecb475719",
                            Name = "Moderator",
                        ...
                        {
                            Id = "admin-id",
                            ConcurrencyStamp = "9c99da5d-424c-4637-b021-886e2cb732fc",
                            Name = "Admin",
            ...
            modelBuilder.Entity("API.Entities.MemberLike", b =>
                {
                    b.HasOne("API.Entities.Members", "SourceMember")
                        .WithMany("LikedMembers")
                        .HasForeignKey("SourceMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("API.Entities.Members", "TargetMember")
            ...
            modelBuilder.Entity("API.Entities.Message", b =>
                {
                    b.HasOne("API.Entities.Members", "Recipient")
                        .WithMany("MessagesRecived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("API.Entities.Members", "Sender")
            ...
            modelBuilder.Entity("API.Entities.Photo", b =>
                {
                    b.HasOne("API.Entities.Members", "Member")
                        .WithMany("Photos")
