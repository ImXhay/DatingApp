...
public class LikesController(ILikesRepository likesRepository) : BaseApiController
{
    ...
    public async Task<ActionResult> ToggleLike(string targetMemberId)
    {
        ...
        if (sourceMemberId == targetMemberId) return BadRequest("Sorry you cannot like yourself");
    ...
    [HttpGet]
    public async Task<ActionResult<PaginatedResult<Members>>> GetMemberLikes([FromQuery] LikeParams likesParams)
    {
